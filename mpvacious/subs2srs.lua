...
local config = {
    -- Common
    autoclip = true, -- enable copying subs to the clipboard when mpv starts
    ...
    use_ffmpeg = true, -- if set to true, use ffmpeg to create audio clips and snapshots. by default use mpv.
    snapshot_format = "webp", -- webp or jpg
    snapshot_quality = 100, -- from 0=lowest to 100=highest
    snapshot_width = -2, -- a positive integer or -2 for auto
    snapshot_height = 200, -- same
    audio_format = "opus", -- opus or mp3
    audio_bitrate = "32k", -- from 16k to 32k
    ...
    deck_name = "MyMining", -- name of the deck for new cards
