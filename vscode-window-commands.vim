...
nnoremap <silent> <C-w><C-j> :<C-u>call VSCodeNotify('workbench.action.focusBelowGroup')<CR>
xnoremap <silent> <C-w><C-j> :<C-u>call VSCodeNotify('workbench.action.focusBelowGroup')<CR>
...
nnoremap <silent> <C-w><C-k> :<C-u>call VSCodeNotify('workbench.action.focusAboveGroup')<CR>
xnoremap <silent> <C-w><C-k> :<C-u>call VSCodeNotify('workbench.action.focusAboveGroup')<CR>
...
nnoremap <silent> <C-w><C-h> :<C-u>call VSCodeNotify('workbench.action.focusLeftGroup')<CR>
xnoremap <silent> <C-w><C-h> :<C-u>call VSCodeNotify('workbench.action.focusLeftGroup')<CR>
...
nnoremap <silent> <C-w><C-l> :<C-u>call VSCodeNotify('workbench.action.focusRightGroup')<CR>
xnoremap <silent> <C-w><C-l> :<C-u>call VSCodeNotify('workbench.action.focusRightGroup')<CR>
